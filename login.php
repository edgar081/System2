...
<head>
	...
	<title>SoftTech - Iniciar Sesión</title>
 ...
 <script type="text/javascript">
	...
	if(document.getElementById('mymail').value == "")
   {
	alert("Por favor Ingresa tu email");
		  ...
		  document.getElementById("data").innerHTML = "Espera porfavor...";
      var xmlhttp;
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">Acerca Platea21</h5>
											<p>SoftTech es un portal dedicado a la programacion web y escritorio 2018.</p>
