...
<head>
	...
	<title>Platea21 - Contact Us</title>
		...
		<div class="main-wrapper">
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Dirección</h5>
										<address> Durango, <br/>Mexico <br/> </address>
								</li>
								<li>
										<h5>Correo Electrónico</h5><a href="mailto:jorgeantoniotf@gmail.com">jorgeantoniotf@gmail.com</a>
								</li>
								<li>
			...
			<footer class="footer-wrapper">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-9">
								...
								<div class="row">
									...
									<div class="footer-about-us">
											<h5 class="footer-title">Acerca SoftTech</h5>
											<p>SoftTech es un portal dedicado a la programacion web y escritorio 2021.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Equipo 5 SoftTech</h5>
								
								<p>Dirección : Durango - México</p>
								<p>Correo Electrónico : <a href="mailto:jorgeantoniotf@gmail.com">jorgeantoniotf@gmail.com</a></p>
								<p>Celular : <a href="tel:+51948445199">+51948445199</a></p>
				...
				<div class="bottom-footer">
					...
					<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> SoftTech</p>
				...
				<div class="col-sm-4 col-md-4">
					...
					<ul class="bottom-footer-menu">
						<li><a >Desarrollado por @equipo5</a></li>
					</ul>
